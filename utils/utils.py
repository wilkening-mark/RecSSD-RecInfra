...
def cli():
    ...
    # =========================================================================================
    # NDP related configurations
    # =========================================================================================
    parser.add_argument("--sls_type", type=str, default="dram")
    ...
    parser.add_argument("--model_type", type=str, default="dlrm", help="Type of model to run (dlrm | wnd | ncf)")
    ...
    parser.add_argument("--avg_mini_batch_size", type=int, default=1)
    parser.add_argument("--var_mini_batch_size", type=int, default=1)
    ...
    parser.add_argument("--data_trace_file", type=str,default="./input/dist_1_emb_j.log") # distribution information
    parser.add_argument("--data_file", type=str,default="ids_1.pkl") # id information
    ...
    parser.add_argument("--look_back", type=int, default=15)
    parser.add_argument("--unique_arrivals", type=int, default=3)
    ...
    parser.add_argument("--tune_gpu_qps", action="store_true", default=False)
    parser.add_argument("--gpu_configs", type=str, default="128-256-512")
    ...
    parser.add_argument("--analytical_model", action="store_true", default=False)

    # =========================================================================================
    # Hardware related configurations
    # =========================================================================================
    parser.add_argument("--use_gpu", action="store_true", default=False)
    parser.add_argument("--model_gpu", action="store_true", default=False)
    parser.add_argument("--gpu_request_size_thres", type=int, default=1024)
    parser.add_argument("--model_name", type=str, default=None)
    parser.add_argument("--gpu_root_dir", type=str, default="gpu_characterization/")
